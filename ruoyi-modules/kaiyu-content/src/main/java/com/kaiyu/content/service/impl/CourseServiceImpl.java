...
//            System.out.println("从缓存中获取数据");
            ...
            //设置过期时间
            redisTemplate.expire("getCourses",60 + new Random().nextInt(100), TimeUnit.SECONDS);
    ...
    public PageResult<CourseCategoryVo> queryCourseByMultipleConditions(PageParams pageParams, QueryAdminCourseDto queryCourseDto) {
        ...
        //获取数据集
        List<CourseCategoryVo> courseCategoryVos = courseMapper.queryCourseByMultipleConditions(pageParams, queryCourseDto);
