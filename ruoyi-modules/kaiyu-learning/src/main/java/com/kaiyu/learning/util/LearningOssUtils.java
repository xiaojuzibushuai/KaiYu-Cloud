package com.kaiyu.learning.util;
...
@Component
public class LearningOssUtils {

    private static final Logger log = LoggerFactory.getLogger(LearningOssUtils.class);

    @Value("${aliyun.oss.endpoint}")
    private String endpoint;
//    private String endpoint = "http://oss-cn-wuhan-lr.aliyuncs.com";

    @Value("${aliyun.oss.accessKeyId}")
    private String accessKeyId;
//    private String accessKeyId = "LTAI5tQEh2XoHCLNQV1zGUNt";

    @Value("${aliyun.oss.accessKeySecret}")
    private String accessKeySecret;
//    private String accessKeySecret = "905YkQEFw7kdiPLEv2clz6Xb7VrySG";
